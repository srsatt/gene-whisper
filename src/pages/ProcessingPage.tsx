  ...
  return (
    <div className="py-12">
      ...
      <div className="text-center pt-4">
        <button
          onClick={onCancel}
          className="text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:underline cursor-pointer px-3 py-1 rounded-md transition-all duration-200 ease-in-out"
        >
          Cancel & re-upload
        </button>
      </div>
